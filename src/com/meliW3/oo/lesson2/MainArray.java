...
//        }
        ...
        roupas[0] = new Roupa("casaco", "Preta", "slim", "p", "Outono/inverno");
        //roupas[0] = new Roupa();
...
//        roupas[0].descricao = "casaco";
        ...
        roupas[1] = new Roupa("camiseta", "Branca", "Despojada", "P", "Primavera/Verão");
//        roupas[1] = new Roupa();
...
//        roupas[1].descricao = "camiseta";
        ...
        roupas[2] = new Roupa("blusa", "Azul", "Slim", "P", "Outono/Inverno");
//      roupas[2] = new Roupa();
//        roupas[2].colecao = "Outono/inverno";
//        roupas[2].cor = "Azul";
//        roupas[2].modelo = "Slim";
//        roupas[2].tamanho = "P";
//        roupas[2].descricao = "blusa";

        roupas[3] = new Roupa("Bermuda", "Jeans", "curta", "P", "Verão");
////      roupas[3] = new Roupa();
...
//        roupas[4] = new Roupa();
        ...
        roupas[4] = new Roupa("Calca", "Laranja", "Larga", "G", "Outono/Inverno");
